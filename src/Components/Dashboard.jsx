...
const BarChart = () => {
  ...
  const active = 3;   // Wednesday
  const green2 = 1;   // Monday (lighter green)

  return (
    <div className="w-full mt-4">
      {/* SVG stripe pattern definition */}
        ...
        {days.map((d, i) => {
          ...
          return (
            <div
              ...
              style={{ height: "100%" }}
            >
              {/* percentage label — only on active */}
              <div className="flex-1 flex flex-col justify-end items-center w-full">
                ...
                {/* Bar */}
                {isStripe ? (
                  // Striped bar using SVG so pattern fills a pill shape
                  <svg
                    width="100%"
                    height={barHeight}
                    viewBox="0 0 30 100"
...
export default function Dashboard() {
  ...
  // fetch users for team collaboration
  useEffect(() => {
    axios
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans overflow-hidden">
      {/* ── SIDEBAR ─────────────────────────────────────────────────────── */}
      <aside className="w-56 bg-white flex flex-col py-6 px-4 gap-6 flex-shrink-0 shadow-sm">
        {/* Logo */}
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        {/* Top bar */}
        <header className="bg-white px-6 py-3 flex items-center gap-4 flex-shrink-0 border-b border-gray-100">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex items-start justify-between mb-5">
            ...
            <div className="flex gap-2">
              <button className="flex items-center gap-2 bg-[#1a5c3a] text-white text-sm font-semibold px-4 py-2 rounded-xl hover:bg-[#154d30] transition-all">
                <MdAdd /> Add Project
              </button>
              <button className="flex items-center gap-2 border border-gray-200 text-sm font-semibold px-4 py-2 rounded-xl hover:bg-gray-50 transition-all">
          ...
          <div className="grid grid-cols-4 gap-4 mb-4">
            {/* Total Projects — fetched */}
            <div className="bg-[#1a5c3a] text-white rounded-2xl p-5 flex flex-col gap-2 relative">
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div className="bg-white rounded-2xl p-5 flex flex-col gap-4">
              ...
              <button className="flex items-center justify-center gap-2 bg-[#1a5c3a] hover:bg-[#154d30] text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-all">
                <MdVideocam />
                Start Meeting
              </button>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            {/* Time Tracker */}
            <div className="bg-[#1a5c3a] rounded-2xl p-5 flex flex-col justify-between text-white">
